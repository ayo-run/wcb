...
Sa runtime, ang pag-assign ng ibang type sa isang prop ay tahimik na nabibigo. Ang pag-set ng [`static strictProps`](/api/web-component/#static-strictprops) sa true ay magtatapon ng `TypeError` kapag may na-assign na maling type.
</Aside>
...
[`this.render()`](/template-vs-render/) kapag dapat mag-update ng view ang pagbabago sa isa.

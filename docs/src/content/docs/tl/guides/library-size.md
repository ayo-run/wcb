...
Ang `WebComponent` base class ay **1.98 kB** (min + brotli) ayon sa [size-limit](http://github.com/ai/size-limit).

Bawat pagbabago na nagpapagalaw sa numerong ito ay naitatala sa [`size-change-log.md`](https://github.com/ayo-run/wcb/blob/main/size-change-log.md), kasama ang dahilan kung bakit ginastos ang mga byte at ang benepisyong binili ng mga ito.

...
| Reactive props ⇄ attributes      | ✅ `static props`, overrideable converters                              | ✅ `static props`, opt-in reflection    | ✅ `static properties` with converters                   | ✅ `@attr` / observables                         |
...
| Keyed list reconciliation        | ✅ positional                                                           | ❌                                      | ✅ `repeat` directive                                    | ✅ `repeat` with recycling controls              |
